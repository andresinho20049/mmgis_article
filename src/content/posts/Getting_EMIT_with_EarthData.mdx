---
title: Emit Getting with Earthdata search
description: Getting Started with Earth Surface Mineral Dust Source Investigation (EMIT) data in Earthdata Search
date: 2023-10-08
---
