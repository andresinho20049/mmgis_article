...
export const Breadcrumb = (
    ...
    return (
        <nav className="text-sm sm:text-base p-4 md:p-6 lg:p-6 rounded-md shadow-lg dark:bg-neutral-900 dark:prose-invert">
            <ol className="list-none p-0 inline-flex space-x-2">
                <li className="flex items-center">
                    <a href="/" className="text-gray-600 hover:text-primary-500 transition-colors duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512" className="cursor-pointer hover:fill-primary-500 transition-colors duration-300" fill="#4b5563">
                ...
                <li className="flex items-center">
                    <a href="/posts" className="text-gray-600 hover:text-primary-500 transition-colors duration-300">Posts</a>
                    <span className="mx-2">/</span>
                </li>
                <li className="flex items-center">
